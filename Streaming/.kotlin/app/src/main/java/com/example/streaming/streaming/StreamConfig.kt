...
data class StreamConfig(
        val rtmpUrl: String = "rtmp://192.168.1.124:1935/live",
    ...
    companion object {
        /**
         * Preset de baja calidad - Para conexiones lentas 480p @ 15fps, 500 Kbps video, 64 Kbps
         * audio
         */
        val LOW_QUALITY =
                StreamConfig(
        ...
        /**
         * Preset de calidad media - Balance entre calidad y ancho de banda 720p @ 24fps, 1.5 Mbps
         * video, 96 Kbps audio
         */
        val MEDIUM_QUALITY =
                StreamConfig(
        ...
        /**
         * Preset de alta calidad - Para conexiones rápidas 720p @ 30fps, 2.5 Mbps video, 128 Kbps
         * audio
         */
        val HIGH_QUALITY =
                StreamConfig(
